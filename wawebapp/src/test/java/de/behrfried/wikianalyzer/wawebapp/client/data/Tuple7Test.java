...
import de.behrfried.wikianalyzer.wawebapp.client.util.data.Tuple7;
...
public class Tuple7Test {
	...
	public void testConstruction() {
		...
		final Tuple7<Integer, String, Double, Object, StringBuilder, Character, Boolean> result = new Tuple7<Integer, String, Double, Object, StringBuilder, Character, Boolean>(
