...
public class Tuple8<E, G, I, K, M, O, Q, S> {
	 ...
	 *            the eighth value
	 */
	public Tuple8(final E item1, final G item2, final I item3, final K item4, final M item5, final O item6, final Q item7, final S item8) {
		this.item1 = item1;
		this.item2 = item2;
		this.item3 = item3;
		this.item4 = item4;
	...
	public int hashCode() {
		...
		result = prime * result + (this.item8 == null ? 0 : this.item8.hashCode());
		return result;
	}
