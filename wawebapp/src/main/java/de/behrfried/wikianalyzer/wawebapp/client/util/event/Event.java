...
public class Event<E extends EventArgs> {
	...
	public final class EventHandlerRegistration {
		...
		/**
		 * Removes the encapsulated {@link Handler} from the {@link de.behrfried.wikianalyzer.wawebapp.client.util.event.Event}
		 *
	 ...
	 * {@link de.behrfried.wikianalyzer.wawebapp.client.util.event.Event} only can be fired within its initialization class. the The
	...
	/**
	 * Fires this {@link de.behrfried.wikianalyzer.wawebapp.client.util.event.Event} by invoking all associated {@link Handler}'s.
	 *
	 * @param initContext
	 ...
	 * @param e
	 *            an instance of {@link de.behrfried.wikianalyzer.wawebapp.client.util.event.EventArgs} containing several
