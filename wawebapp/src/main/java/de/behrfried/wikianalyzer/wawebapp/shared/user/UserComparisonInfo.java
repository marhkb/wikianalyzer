...
public class UserComparisonInfo implements Serializable {
    ...
    private double cooperationRatio, categoryCongruency;
...
//	private List<ArticleEdited> editedCategories;
	...
	public UserComparisonInfo(UserInfo userInfo1, UserInfo userInfo2, double cooperationRatio, double categoryCongruency, int amountAbusesUser1, int amountAbusesUser2) {
