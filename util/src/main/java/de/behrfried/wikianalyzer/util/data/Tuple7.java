...
public class Tuple7<E, G, I, K, M, O, Q> {
	...
	/**
	 * Calculates a hash code based on each item this Tuple7 contains.
	 * 
	 * @return a hash code based on each item this Tuple7 contains
	 */
	@Override
	public int hashCode() {
		final int prime = 31;
	...
	/**
	 * Compares this Tuple7 with the passed {@link Object}. Only an instance of
